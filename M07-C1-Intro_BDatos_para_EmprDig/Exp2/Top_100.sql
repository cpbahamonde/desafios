...
SELECT pelicula, LENGTH(pelicula) AS longitud_titulo FROM Peliculas ORDER BY pelicula;
SELECT pelicula, LENGTH(pelicula) AS longitud_titulo FROM Peliculas ORDER BY LENGTH(pelicula) DESC;
